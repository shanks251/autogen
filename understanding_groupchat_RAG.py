...
agent_list, agent_configs = builder.build(building_task, llm_config, coding=True, use_oai_assistant=False)
...
def rag_chat():
    ...
    groupchat = autogen.GroupChat(
        agents=[boss_aid, currency_aid], messages=[], max_round=12, speaker_selection_method="auto"
    )
